...
def get_answer():
    try:
        ...
        if route_num == 0:
            ...
            prompt_template = (
                "당신은 보험 추천 도우미입니다. 아래의 문맥을 참고하여 3개 보험사를 비교하여 질문에 정확하고 이해하기 쉬운 답변을 간결하게 요약해서 해주세요.\n"
                "문맥: {context}\n\n"
                "질문: {question}\n"
                "답변:"
            )
            ...
            prompt_template = (
                "당신은 노령견 전문 정보 제공 도우미입니다. 아래의 문맥을 참고하여 질문에 정확하고 이해하기 쉬운 답변을 간결하게 요약해서 해주세요.\n"
                "문맥: {context}\n\n"
                "질문: {question}\n"
                "답변:"
            )
            ...
            prompt_template = (
                ...
                "아래의 문맥을 참고하여 사용자가 원하는 서비스를 파악한 후 가장 적합한 장례식장을 문맥에서 찾아 간결하게 요약해서 안내해주세요.\n"
                "문맥: {context}\n\n"
                "질문: {question}\n"
                "답변:"
            )
